...
function getAsteroidDirectionAndSpeed() {
    ...
    if (direction == 0){
        ...
        return {
            ...
            speed_x: (-Math.floor(Math.random() * 1.1) - 1),
            // brzina y je random broj između -0.5 i 0.5 kako bi asteroid imao jednake šanse ići gore i dolje
            speed_y: Math.floor((Math.random() * 1) - 0.5)
        };
        ...
        // smjer gore
            ...
            return {
                ...
                // brzina x je random broj između -0.5 i 0.5 kako bi asteroid imao jednake šanse ići lijevo i desno
